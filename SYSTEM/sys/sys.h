...
extern int   enconder_left,enconder_right,all;        //左右编码器的脉冲计数
...
extern volatile u32 time;          //系统运行时间
...
extern float velocity_KP_Inc;     // 小车速度环PI参数增量
extern float velocity_KI_Inc;
extern float balance_UP_KD_Inc;
extern float balance_UP_KP_Inc; 	 // 小车直立环PD参数增量

extern int Position_Zero,ZHONGZHI;      //位置中值和角度中值
extern float Balance_KP,Balance_KD,Position_KP,Position_KD;  //PID系数

extern volatile u8 time_count;   //0.1ms计时
extern volatile u32 count_ms;
